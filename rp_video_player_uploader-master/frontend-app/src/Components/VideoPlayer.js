...
// function VideoPlayer() {
//   const { id } = useParams();
//   const { videos, getAllVideosAndQuizzes, quizzes } = useGlobalContext();
...
//   useEffect(() => {
//     getAllVideosAndQuizzes(id);
//   }, [id, getAllVideosAndQuizzes]);

//   const closeQuiz = () => {
//     setActiveQuiz(null);
//     playerRef.current?.play(); // Continue playing after closing quiz
//   };
...
//         if (Math.abs(currentTime - quiz.time) < 0.5 && !quiz.shown) {
//           quiz.shown = true; // Prevent multiple triggers
//           setActiveQuiz(quiz);
//         }
//       });
//     });
...
//     player.on("ended", () => {
//       setActiveQuiz(null); // Reset quiz on video end
//     });
